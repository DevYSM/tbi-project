@extends('admin.app')
@section('title', 'Projetcs Management')
@section('content')
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('projects.create') }}"
                                class="btn btn-sm btn-danger">{{ __('Add New Projetcs') }} <i
                        ...
                        <table class="table table-bordered table-striped dataTable dtr-inline data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('projects.show', $items->id) }}"
                                            class="text-danger">{{ $items->main_title }}</a></td>

    
                                    <td>
                                        <a onclick="confirmDelete('{{ route('projects.destroy', $items->id) }}')">
                                        ...
                                        <a href="{{ route('projects.edit', $items->id) }} " class="btn btn-info btn-sm"
                                            data-toggle="tooltip" data-original-title="Edit" title="Edit">
                                            <i class="fa fa-edit"></i></a>
                                        @if($items->status == 0)
                                        <a href="{{ route('projects.unactive', $items->id) }}" data-toggle="tooltip"
                                            data-original-title="Unactive" class="btn btn-dark btn-sm" title="Unactive">
                                            <i class="fas fa-times"></i>
                                        </a>
                                        @else
                                        <a href="{{ route('projects.active', $items->id) }}" data-toggle="tooltip"
